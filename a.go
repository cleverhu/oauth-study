...
import (
	...
	"golang.org/x/oauth2"
	"oauth2-study/src/utils"
)

const (
	authServerURL = "http://oauth.deeplythink.com"
)
...
var (
	myOAuth = oauth2.Config{
		...
		ClientSecret: "123",
		Scopes:       []string{"all"},
		RedirectURL:  "http://localhost:8080/deeplythink/getcode",
...
func main() {
	...
	r.LoadHTMLGlob("src/public/*")
	loginUrl := myOAuth.AuthCodeURL("myclient")
	...
	r.GET("/deeplythink/getcode", func(c *gin.Context) {
		source := "deeplythink"           //来源
